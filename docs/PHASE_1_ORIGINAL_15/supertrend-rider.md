# Phase 1 Original-15 Validation — `supertrend-rider`

**Template name:** Supertrend Rider
...
- `indicators`: ['supertrend_10_3']
- `entry_long.condition`: `"supertrend flips to bullish (close > supertrend)"`
- `exit_long.condition`: `"supertrend flips to bearish"`
