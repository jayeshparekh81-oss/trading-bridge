# Phase 1 Original-15 Validation — `rsi-oversold-bounce`

**Template name:** RSI Oversold Bounce
...
- `indicators`: ['rsi_14']
- `entry_long.condition`: `"rsi_14 crosses above 30 from below"`
- `exit_long.condition`: `"rsi_14 > 70 OR rsi_14 crosses below 50"`
