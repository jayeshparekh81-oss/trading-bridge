# Phase 1 Original-15 Validation — `vwap-bounce`

**Template name:** VWAP Bounce
...
- `indicators`: ['vwap']
- `entry_long.condition`: `"prior bars > vwap AND current low touches vwap AND close > vwap"`
- `exit_long.condition`: `"close > vwap * 1.01 OR close < vwap"`
