# Phase 1 Original-15 Validation — `bb-rsi-oversold`

**Template name:** BB + RSI Oversold
...
- `entry_long.condition`: `"low <= bb_lower AND rsi_14 < 30"`
- `exit_long.condition`: `"close >= bb_middle OR rsi_14 > 50"`
