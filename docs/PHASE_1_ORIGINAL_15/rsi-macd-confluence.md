# Phase 1 Original-15 Validation — `rsi-macd-confluence`

**Template name:** RSI + MACD Confluence
**Category:** Momentum
...
- `entry_long.condition`: `"rsi_14 > 50 AND macd_line > signal_line"`
- `exit_long.condition`: `"rsi_14 < 50 OR macd_line < signal_line"`
