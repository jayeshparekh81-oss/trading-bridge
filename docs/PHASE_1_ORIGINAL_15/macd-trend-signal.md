# Phase 1 Original-15 Validation — `macd-trend-signal`

**Template name:** MACD Trend with Signal Cross
**Category:** Momentum
...
- `entry_long.condition`: `"macd_line crosses above signal_line AND macd_histogram > 0"`
