...
const hinglish: Dict = {
  ...
  ob_levels_note: "Upar se shuru karo. Jab chaho, Pro mode se sab dekh sakte ho.",
  nudge_home_first: "Pehle upar wale 4 karo, phir ‘Aur seekhein’ — aur Pro mode se kabhi bhi sab dekh sakte ho.",
  shell_back: "Wapas",
  ...
  tip_build: "Yahan aap apni strategy khud banate ho — 5 aasan sawaal, phir test.",
...
const hi: Dict = {
  ...
  ob_levels_note: "ऊपर से शुरू करो। जब चाहो, प्रो मोड से सब देख सकते हो।",
  nudge_home_first: "पहले ऊपर वाले 4 करो, फिर ‘और सीखें’ — और प्रो मोड से कभी भी सब देख सकते हो।",
  shell_back: "वापस",
  ...
  tip_build: "यहाँ आप अपनी स्ट्रैटेजी खुद बनाते हो — 5 आसान सवाल, फिर टेस्ट।",
...
const gu: Dict = {
  ...
  ob_levels_note: "ઉપરથી શરૂ કરો. જ્યારે ઈચ્છો, પ્રો મોડથી બધું જોઈ શકો છો.",
  nudge_home_first: "પહેલા ઉપરના 4 કરો, પછી ‘વધુ શીખો’ — અને પ્રો મોડથી ગમે ત્યારે બધું જોઈ શકો છો.",
  shell_back: "પાછા",
  ...
  tip_build: "અહીં તમે તમારી સ્ટ્રેટેજી જાતે બનાવો છો — 5 સરળ સવાલ, પછી ટેસ્ટ.",
...
const en: Dict = {
  ...
  ob_levels_note: "Start from the top. Whenever you like, Pro mode shows everything.",
  nudge_home_first: "Do the four above first, then ‘Learn more’ — and Pro mode shows everything any time.",
  shell_back: "Back",
  ...
  tip_build: "Here you build your own strategy — five easy questions, then a test.",
