    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-4 md:px-6">
        <Link href="/home" className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg">TradeForge</span>
        </Link>
    ...
    <footer className="border-t border-border bg-background/50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold">TradeForge</span>
            </div>
            <p className="text-xs text-muted-foreground">India&apos;s fastest algo trading bridge. Built by L&amp;T Engineer.</p>
          </div>
          {cols.map((col) => (
            <div key={col.title}>
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <span>Made in India | Built by L&amp;T Engineer | &copy; 2026 TradeForge. All rights reserved.</span>
