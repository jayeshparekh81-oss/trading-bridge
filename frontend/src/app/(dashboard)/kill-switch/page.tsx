  ...
  const primaryAction = status ? (
    !isTripped ? (
      <Dialog open={tripDialogOpen} onOpenChange={setTripDialogOpen}>
        ...
        >
          <ShieldX className="h-4 w-4 mr-2" /> Trip Kill Switch
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
      ...
      <Dialog open={resetDialogOpen} onOpenChange={setResetDialogOpen}>
        ...
        >
          <RotateCcw className="h-4 w-4 mr-2" /> Reset Kill Switch
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
          ...
          <>
            ...
            <motion.div variants={fadeUp}>
              <p className="text-xs text-muted-foreground max-w-2xl">
                Trip immediately stops all order placement. All open positions are squared
                off via the broker. Auto-refresh every 15s.
              </p>
            </motion.div>
